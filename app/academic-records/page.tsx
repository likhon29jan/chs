  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl bg-gradient-to-br from-green-500 to-green-600 p-6 text-center text-white shadow-lg">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-center text-white shadow-lg">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 p-6 text-center text-white shadow-lg">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-lg">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <a
            ...
            className="flex items-center gap-3 rounded-lg bg-green-50 p-4 transition-colors hover:bg-green-100"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 rounded-lg bg-blue-50 p-4 transition-colors hover:bg-blue-100"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 rounded-lg bg-orange-50 p-4 transition-colors hover:bg-orange-100"
          >
