...
export const metadata: Metadata = {
  ...
  description:
    "চলিশীয়া উচ্চ বিদ্যালয় (Chalishia High School) - বেসরকারি মাধ্যমিক বিদ্যালয়, EIIN: 115498, যশোর জেলা, অভয়নগর উপজেলা, চলিশীয়া ইউনিয়ন। যশোর শিক্ষা বোর্ড অধীনস্থ।",
  keywords: [
